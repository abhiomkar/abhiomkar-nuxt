...
<div class="container">
  ...
  <project-card v-for="project in projects" v-bind:project="project" v-bind:key="project.url"></project-card>
  <a class="view-all-link" href="https://github.com/abhiomkar">
